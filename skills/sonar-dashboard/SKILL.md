...
```bash
python .claude/skills/sonar-dashboard/scripts/generate_dashboard.py [OPTIONS]
```
...
```bash
python .claude/skills/sonar-dashboard/scripts/generate_dashboard.py $ARGUMENTS
```
