...
# Usage: .claude/skills/sonar-develop/scripts/setup_test_env.sh

set -euo pipefail

# ============================================
# 프로젝트 루트 동적 취득 (bash-execution-rules 준수)
# ============================================
...
echo "  .claude/skills/sonar-develop/scripts/run_tests.sh --worktree worktrees/{issue_key} --target tests/sonar_tdd/"
